...
<div class="row border border-success" style="background-color: 	#AFE1AF;">
    <div class="offset-lg-1 col-12 col-lg-10 text-center">
        <div class="row  justify-content-center ">
            ...
            ?>
                ...
                <div class="card col-12 col-lg-2 mt-4 mb-2 me-2" style="width: 20rem;">
                    <img src="<?php echo $product_img_data["img_path"] ?>" class="card-img-top img-thumbnail mt-2 object-fit-contain" style=" height:350px;" />
    ...
    <div class="offest-2 offset-lg-3 col-8 col-lg-6 text-center mb-3">
