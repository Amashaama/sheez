...
<div class="col-12 text-md-start">
    ...
    <div class="co-12 col-md-3 col-lg-3 mx-auto mt-3">
                <h5 class="text-uppercase text-warning mb-4">sheez</h5>
                <p>
                    sheez.lk&trade; Your clothing choice
                </p>

            </div>
            <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                <p>Copyright &copy; 2024 sheez All Rights Reserved</p>
                <p>Designed By <b>M.H.S.Amasha&trade;</b></p>
            </div>
            ...
            <div class="col-12 col-md-4 col-lg-3 mx-auto mt-3">
                ...
                <p><i class="bi bi-house-fill"></i> No 87 Gampola road, Sri Lanka</p>
                <p><i class="bi bi-envelope-at-fill"> sheez5@gmail.com</i></p>
                <p><i class="bi bi-telephone-fill"></i> +94112 980 896</p>
                <p><i class="bi bi-printer-fill"></i> +94113 890 897</p>
