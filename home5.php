            ...
            <div class="row">
                ...
                ?>
                    ...
                    <div class="col-12 mt-3 mb-3 text-center">
                        ...
                        if ($c_data["cat_id"] == 1) {
                        ?>
                            <a href="home2.php?id=<?php echo $catno; ?>" class="text-decoration-none text-dark fs-6">See All&nbsp;&rarr;</a>
                        <?php
                        } else if ($c_data["cat_id"] == 2) {
                        ?>
                            <a href="home2.php?id=<?php echo $catno; ?>" class="text-decoration-none text-dark fs-6">See All&nbsp;&rarr;</a>
                        <?php
                        } else if ($c_data["cat_id"] == 3) {
                        ?>
                            <a href="home2.php?id=<?php echo $catno ?>" class="text-decoration-none text-dark fs-6">See All&nbsp;&rarr;</a>
                        <?php
                        } else if ($c_data["cat_id"] == 4) {
                        ?>
                            <a href="home2.php?id=<?php echo $catno ?>" class="text-decoration-none text-dark fs-6">See All&nbsp;&rarr;</a>
                        <?php
                        }
                    ...
                    <div class="row  mt-2 mb-4">
                        ...
                        ?>
                            ...
                            <div class="avatar2 col-12 col-md-6 col-lg-3 mt-5  mb-5">
                                <div class="avatar_card">
                                    ...
                                    <div class="details">
                                        ...
                                        <button onclick="addToCart(<?php echo $product_data['id'];  ?>)" class="col-12 btn btn-dark mt-2">
                ...
                $brand_load_rs = Database::search("SELECT * FROM `brand_img`");
                $brand_load_num = $brand_load_rs->num_rows;
                ...
                <div class="col-12 my-5">
                    ...
                    <div class="carousel" data-flickity='{"wrapAround": true,  "autoPlay":  true}'>
                        ...
                        for ($z = 0; $z < $brand_load_num; $z++) {
                            $brand_load_data = $brand_load_rs->fetch_assoc();
                        ?>
                          <!--  <div class="ms-2 me-2" style="width: 350px; height:575px;"><img src="<?php echo $brand_load_data["brand_img_path"]; ?>"></div> -->
                          <div class="carousel-cell " ><img src="<?php echo $brand_load_data["brand_img_path"]; ?>"></div>
