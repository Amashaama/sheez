...
?>
        ...
        <head>
            ...
            <title>Update Product | sheez</title>
        ...
        <body>
            ...
            <div class="container-fluid ">
                <div class="row gy-3 d-flex justify-content-center add-product border">

                  

                    <div class="col-10  border-1 border-black p-4 " style="background-color: azure;">
                        <div class="row">

                            <div class="col-12 text-center mt-2 mb-3">
                                <h2 class="h2 text-success fw-bold">Update Product</h2>
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 border border-primary rounded">
                                                        <img src="<?php echo $img[3]; ?>" class="img-fluid" style="width: 250px;" />
                                                    </div>
                                                </div>
                                            </div>
