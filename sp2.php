...
<hr/>
                ...
                <div class="col-12" style="background-color:  #7A7474;">
                    ...
                    <div class="row d-flex justify-content-center align-items-center flex-row g-2">
                        ...
                        for ($w = 0; $w < $related_num; $w++) {
                            ...
                            $related_img_rs = database::search("SELECT * FROM `product_img` WHERE `Product_id`='" . $product_data["id"] . "' ");
                        ...
                        ?>
                            <div class="offset-lg-0 col-4 col-lg-4 m-4">
