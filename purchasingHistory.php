...
<head>
    ...
    <title>Purchasing History | sheez</title>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-1 bg-info text-center text-lg-start">
                                            <label class="form-label text-white fs-6 py-5"></label>
                                        </div>
                                                    ...
                                                    <div class="row g-0">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="card-body">
                                                                ...
                                                                <h5 class="card-title">Tea pot</h5>
                                                                <p class="card-text"><b>Seller : </b>kasun kalhara</p>
                                        ...
                                        <div class="col-12 col-lg-1 text-center text-lg-end">
                                            <label class="form-label fs-4 py-5">12</label>
                                        </div>
                                        <div class="col-12 col-lg-2 text-center text-lg-end bg-info">
                                            <label class="form-label fs-5 py-5 text-white">Rs. 20000 .00</label>
                                        </div>
                                        <div class="col-12 col-lg-2 text-center text-lg-end">
                                            <label class="form-label fs-5 px-3 py-5">2024/1/10</label>
                                        </div>
                                        <div class="col-12 col-lg-3">
                                            <div class="row">
                                                <div class="col-6 d-grid">
                                                    <button class="btn btn-secondary rounded border border-1 border-primary mt-5 fs-5" onclick="addFeedback();">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-outline-primary" onclick="saveFeedback();">Save Feedback</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
