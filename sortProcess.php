...
$category = $_POST["cat"];
    ...
    if ($time != "0" && $qty != "0") {
        if ($qty == "1") {
            $query .= " ORDER BY `qty` DESC, `datetime_added` DESC";
        } else if ($qty == "2") {
            $query .= " ORDER BY `qty` ASC, `datetime_added` ASC";
        }
    } elseif ($time != "0") {
        if ($time == "1") {
...
<div class="offset-1 col-10 text-center">
    <div class="row justify-content-center">
        ...
        for ($x = 0; $x <  $selected_num; $x++) {
            ...
            // Move the code that uses $selected_data here...

            // <!-- card -->
            // The rest of your card HTML code...
