...
@media screen and (min-width:1024px) and (max-width: 1440px) {
    ...
    @media screen and (min-width: 1024px) {
        .avatar_card {
            flex: 0 0 calc(50% - 2px); /* Adjust the width to make two cards fit in a row */
            max-width: calc(50% - 2px); /* Adjust the width to make two cards fit in a row */
          opacity:0;
        }
    }
            ...
            <div class="avatar">
                <div class="row mt-2 mb-4">
                    ...
                    ?>
                        ...
                        <div class="avatar2 col-12 col-lg-3  mb-2">
